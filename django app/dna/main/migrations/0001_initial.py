# Generated by Django 3.0.1 on 2020-01-05 14:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bac_id', models.CharField(blank=True, max_length=11, null=True, unique=True)),
                ('student_id', models.BigIntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main.Courses')),
                ('date', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main.Scholaryear')),
                ('path', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='main.BacPath')),
            ],
            options={
