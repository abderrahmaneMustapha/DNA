...
var StyledInput = styled__default.input(_templateObject(), function (props) {
...
var StyledDropdown = styled__default.div(_templateObject$1(), function (props) {
...
function (_Component) {
  ...
  _createClass(DropDown, [{
    ...
    value: function render() {
      ...
      }, React__default.createElement("ul", null, matchedRecords.map(function (record) {
...
function (_Component) {
  ...
  _createClass(ReactSearchBox, [{
    ...
    key: "render",
    value: function render() {
      return React__default.createElement(StyledContainer, null, React__default.createElement(GlobalStyle, null), this.inputNode(), this.dropdownNode());
    }
  }]);
